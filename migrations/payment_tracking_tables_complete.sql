-- ============================================================================
-- BILLING V2 MIGRATION: Complete Setup with billing_data
-- Date: 2025-11-12
-- Architect: PunkGrok
-- Mission: Create billing_data + 4 payment tracking tables
-- ============================================================================

-- 0. BASE TABLE: Billing Data (invoices/facturas)
...
CREATE INDEX IF NOT EXISTS idx_billing_data_invoice ON billing_data(invoice_number);
