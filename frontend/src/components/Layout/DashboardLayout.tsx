...
const DashboardLayout: React.FC = () => {
  ...
  const navigationItems = [
    ...
    {
      name: 'Hub Logístico', // 📦🎸 FUSIÓN INVENTORY + MARKETPLACE
      ...
      badge: '📦' // Supply Chain Hub
    },
    // 🔥 DEPRECATED: Marketplace B2B y Órdenes de Compra ahora integrados en Hub Logístico
    {
      name: 'Compliance',
    ...
    // 🔥 DEPRECATED: Órdenes de Compra ahora integrado en Hub Logístico (tab Pedidos)
    {
      name: 'Suscripciones',
